                    ...
                    <div x-data="{ isOpen:false }">
                        ...
                        <div x-show.transition.opacity="isOpen" style="background-color: rgba(0,0,0,.5)"
                            ...
                            <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                                <div class="bg-green-900 rounded">
                                    ...
                                    <div class="modal-body px-8 py-8">
                                        <div class="responsive-container overflow-hidden relative"
                                            ...
                                            <iframe width="560" height="315"
                                                    class="youtube-video responsive-iframe absolute top-0 left-0 w-full h-full"
                                                    src="https://www.youtube.com/embed/{{$movie['videos']['results'][0]['key']}}?enablejsapi=1&version=3&playerapiid=ytplayer"
                                                    style="border: 0"
                    ...
                    <div class="mt-8">
                        <a
                            @click.prevent="
                                ...
                                "
                            href="#">
                            <img src="{{'https://image.tmdb.org/t/p/w300/'.$image['file_path'] }}" alt="actor1"
                                 class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                    </div>
                @endforeach
